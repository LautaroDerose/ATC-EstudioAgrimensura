        ...
        <div className="max-w-[1240px] mx-auto gap-8 mt-6 lg:flex-row flex flex-col lg:items-start items-center">
          ...
          <div className="md:w-1/2">
            ...
            <ul>
              ...
              <div className="flex gap-2">
                <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/company/atcagrimensura/" className="justify-center block md:text-base text-xs mb-2 text-[#cccccc]">
                  <i><FaLinkedin className="flex justify-center items-center text-3xl"/></i>
                </a>
                <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/company/atcagrimensura/" className="justify-center block md:text-base text-xs mb-2 text-[#cccccc] font-bold hover:underline">linkedin.com/company/atcagrimensura</a>
              </div>         
              <div className="flex gap-2">
                <span className="justify-center block text-base mb-2 text-palette1">
